  ...
  __initDefaults() {
    this.defaults = {
      messages: {
        ...
        password: this.formatTpl('请输入6-18位的字母数字组合的密码'),
        qq: this.formatTpl('请输入正确的qq格式'),
      }
    }
  }
  ...
  __initMethods() {
    ...
    that.methods = {
      ...
      password(value, param) {
        return that.optional(value) || /^[A-Za-z0-9]{5,17}$/.test(value)
      },
      /**
       * 验证qq
       */
      qq(value, param) {
        return that.optional(value) || /^[1-9][0-9]{4,}$/.test(value)
      }
